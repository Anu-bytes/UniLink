// The kit stops at inputs, cards and badges, so the buttons the leads,
// testimonials and scholarships screens need share their classes from here
// instead of drifting apart across three tables and two editors.
...
export const SECONDARY_BUTTON =
  "inline-flex h-10 items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3.5 text-[13.5px] font-semibold text-[#334155] transition-colors hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1E6DEB] disabled:cursor-not-allowed disabled:opacity-60";

export const DANGER_BUTTON =
  "inline-flex h-9 items-center gap-1.5 rounded-lg px-3 text-[13px] font-semibold text-[#C81F15] transition-colors hover:bg-[#FFF0EE] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#F82C1F] disabled:cursor-not-allowed disabled:opacity-60";
