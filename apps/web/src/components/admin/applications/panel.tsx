 ...
 * rhythm, but with a slot for a link in the header and no form semantics.
 * Everything on the review screen except the status and the notes is a
...
export function FieldRow({
  ...
  return (
    <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1 border-b border-slate-100 py-2.5 first:pt-0 last:border-b-0 last:pb-0">
      ...
      <dd className="min-w-0 max-w-full text-end text-[13.5px] text-[#334155] [overflow-wrap:anywhere]">
        {children}
      </dd>
    </div>
  );
